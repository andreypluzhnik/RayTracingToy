...
bool rotate_z::hit(const ray& r, double t_min, double t_max, hit_record& rec) const{
    ...
    origin[0] = origin[0] * cos_theta + origin[1] * sin_theta;
    origin[1] = origin[1] * cos_theta - origin[0] * sin_theta;

    direction[0] = direction[0] * cos_theta + direction[1] * sin_theta;
    direction[1] = direction[0] * cos_theta - direction[1] * sin_theta;
    ...
    p[0] = p[0] * cos_theta - p[1] * sin_theta;
    p[1] = p[1] * cos_theta + p[0] * sin_theta;

    normal[0] = normal[0] * cos_theta - normal[1] * sin_theta;
    normal[1] = normal[1] * cos_theta + normal[1] * sin_theta;
